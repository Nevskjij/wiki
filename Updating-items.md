...
An `!update` command pretty much similar to the `!add` command, where you need to tell your bot what item (identifying parameter) and then include the listing settings parameters that you want to update. That's mean [Table 3.2](https://github.com/TF2-Price-DB/tf2autobot-pricedb/wiki/Item-Identifying-parameters#321---name-and-defindex-parameters) and [Table 3.3](https://github.com/TF2-Price-DB/tf2autobot-pricedb/wiki/Listing-settings-parameters#33---item-listing-settings-parameters) can also be used here. In addition to [Table 3.2](https://github.com/TF2-Price-DB/tf2autobot-pricedb/wiki/Item-Identifying-parameters#321---name-and-defindex-parameters), since the items have been added to the pricelist, now you can use a new identifying parameter instead of `name`, `defindex`, and `sku`: the **`item`** identifying parameter.
...
Continue: [Removing an item, items by group, or all items](https://github.com/TF2-Price-DB/tf2autobot-pricedb/wiki/Removing-items)