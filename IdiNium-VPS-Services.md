...
4. **CPX21**:
`[3 vCPU¹, 4 GB RAM, 80 GB NVMe SSD, 20 TB Traffic]` — 5 keys + 15 ref/month
5. **CX31**:
`[2 vCPU⁰, 8 GB RAM, 80 GB NVMe SSD, 20 TB Traffic]` — 6 keys + 30 ref/month
6. **CPX31**:
`[4 vCPU¹, 8 GB RAM, 160 GB NVMe SSD, 20 TB Traffic]` — 9 keys + 40 ref/month
7. **CX41**:
`[4 vCPU⁰, 16 GB RAM, 160 GB NVMe SSD, 20 TB Traffic]` — 12 keys + 15 ref/month
8. **CPX41**:
`[8 vCPU¹, 16 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 17 keys + 40 ref/month
9. **CX51**:
`[8 vCPU⁰, 32 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 22 keys + 35 ref/month
10. **CPX51**:
`[16 vCPU¹, 32 GB RAM, 360 GB NVMe SSD, 20 TB Traffic]` — 38 keys + 15 ref/month
