...
3. **CX21**: 
`[2 vCPU⁰, 4 GB RAM, 40 GB NVMe SSD, 20 TB Traffic]` — 3 keys + 30 ref/month
4. **CPX21**:
...
7. **CX41**:
`[4 vCPU⁰, 16 GB RAM, 160 GB NVMe SSD, 20 TB Traffic]` — 12 keys + 5 ref/month
8. **CPX41**:
`[8 vCPU¹, 16 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 17 keys + 30 ref/month
9. **CX51**:
`[8 vCPU⁰, 32 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 22 keys + 25 ref/month
10. **CPX51**:
`[16 vCPU¹, 32 GB RAM, 360 GB NVMe SSD, 20 TB Traffic]` — 37 keys + 25 ref/month
