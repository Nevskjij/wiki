...
8. **CPX41**:
`[8 vCPU¹, 16 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 18 keys/month
9. **CX51**:
`[8 vCPU⁰, 32 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 22 keys + 40 ref/month
10. **CPX51**:
`[16 vCPU¹, 32 GB RAM, 360 GB NVMe SSD, 20 TB Traffic]` — 38 keys + 20 ref/month
