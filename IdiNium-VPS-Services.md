...
5. **CX31**:
`[2 vCPU⁰, 8 GB RAM, 80 GB NVMe SSD, 20 TB Traffic]` — 6 keys/month
6. **CPX31**:
`[4 vCPU¹, 8 GB RAM, 160 GB NVMe SSD, 20 TB Traffic]` — 9 keys/month
7. **CX41**:
`[4 vCPU⁰, 16 GB RAM, 160 GB NVMe SSD, 20 TB Traffic]` — 11 keys + 5 ref/month
8. **CPX41**:
`[8 vCPU¹, 16 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 16 keys + 10 ref/month
9. **CX51**:
`[8 vCPU⁰, 32 GB RAM, 240 GB NVMe SSD, 20 TB Traffic]` — 20 keys + 25 ref/month
10. **CPX51**:
`[16 vCPU¹, 32 GB RAM, 360 GB NVMe SSD, 20 TB Traffic]` — 34 keys + 25 ref/month
