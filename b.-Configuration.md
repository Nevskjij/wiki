...
|      `DISABLE_REVIEW_ OFFER_NOTE`       | `boolean`  | `false` | By default, it will show notes on each [reason](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1839-L1975)                                                                                                                                                                                                                                                                                                               |
...
|     `CUSTOM_DECLINED_ MESSAGE`      | `string` |  `""`   | Your custom `DECLINED` note. Two parameters can be used - [`%reason%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1422-L1477) and [`%invalid_value_summary%`](https://github.com/idinium96/tf2autobot/blob/master/src/classes/MyHandler.ts#L1479-L1491). |
