...
When updating your environmental variables, almost make sure you restart the bot with the `--update-env` option if you are using PM2. As explained [here](https://github.com/Nicklason/tf2autobot/wiki/PM2#updating-environment-variables) 
#### ecosystem.json
